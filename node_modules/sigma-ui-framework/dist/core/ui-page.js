...
define(["require", "exports", "aurelia-framework", "zeroclipboard", "../utils/ui-utils", "../utils/ui-event", "../utils/ui-formatters"], function(require, exports, aurelia_framework_1, zeroclip_1, ui_utils_1, ui_event_1, ui_formatters_1) {
  "use strict";
  var UIPage = (function() {
  ...
  var UISidebar = (function() {
    ...
    UISidebar.prototype.attached = function() {
      ...
      if (this.element.hasAttribute('padded'))
        this.element.classList.add('ui-pad-all');
      if (this.collapsible)
        document.addEventListener('mousedown', this.__close = function(evt) {
          return _this.closeOverlay(evt);
        });
    };
  ...
  var UIMdView = (function() {
    ...
    UIMdView = __decorate([
      ...
      aurelia_framework_1.inlineView('<template class="ui-markdown"><button data-clipboard-text.bind="__code" ref="__copy">Copy</button><div ref="__md"><slot></slot></div></template>'),
      __metadata('design:paramtypes', [Element])
    ], UIMdView);
    return UIMdView;
  }());
